...
const styles = StyleSheet.create({
  ...
  sub: { fontSize: 20, fontWeight: 'bold', marginVertical: 10, color: '#003366' },
  movItem: { padding: 15, backgroundColor: '#fff', borderRadius: 10, marginBottom: 10, borderLeftWidth: 6, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.1, shadowRadius: 2, elevation: 2, },
  movText: { fontSize: 16, fontWeight: '600', color: '#333' },
  movDate: { color: '#999', fontSize: 12, marginTop: 4 },
});
