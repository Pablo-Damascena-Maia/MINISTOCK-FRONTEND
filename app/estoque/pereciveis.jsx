  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Itens Perecíveis</Text>
        <Text style={styles.headerSubtitle}>Total: {pereciveis.length} produtos</Text>
      </View>

      <TouchableOpacity style={styles.addButton} onPress={() => handleOpenModal()}>
        <Ionicons name="add-circle" size={24} color="#fff" />
        <Text style={styles.addButtonText}>Adicionar Perecível</Text>
      </TouchableOpacity>

      {pereciveis.length === 0 ? (
        <View style={styles.emptyContainer}>
          <Ionicons name="nutrition-outline" size={80} color="#ccc" />
          <Text style={styles.emptyText}>Nenhum item perecível cadastrado</Text>
          ...
          <View style={styles.modalContent}>
            <View style={styles.modalHeader}>
              <Text style={styles.modalTitle}>
                {editMode ? 'Editar Perecível' : 'Novo Perecível'}
              </Text>
